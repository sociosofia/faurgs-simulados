const CACHE='faurgs-simulados-v6';
const STATIC=['./','index.html','css/app.css','css/answer-reveal.css','js/app.js','js/richtext.js','js/support-lines.js','js/answer-reveal.js','manifest.webmanifest','assets/icon.svg'];
